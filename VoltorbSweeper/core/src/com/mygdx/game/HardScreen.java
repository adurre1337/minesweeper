 ...
 */
public class HardScreen implements Screen {
    public final int HEIGHT = 480;

    final Game game;
    Rectangle tile;
    int tileDimension;
    int[][] clicked = new int[30][16];
    int x;
    int y;
    SpriteBatch batch;
    Vector3 vector;
    ...
    public HardScreen(final Game game){
        this.game = game;
        tile = new Rectangle();
        tileDimension = 15;
        batch = new SpriteBatch();
        tiles = new Rectangle[30][16];
        ...
        board = new Board(x,y,40);
        board.resetBoard(numBombs,x,y);
                    ...
                    if (getClicked(i, j) == 0) {
                        ...
                        if (getBoard().getBoard(i,j) == -1){
                            ...
                            if (buffer > 2) {
                                ...
                                getBoard().resetBoard(numBombs,x,y);
                                dispose();
                            }
                        }
                    }
