    ...
    public GameScreen(final Game game){
        ...
        for (int x = 0; x < 9; x++) {
            for (int y = 0; y < 9; y++) {
                ...
                tiles[x][y].set(x * (tileDimension + 1) + 95, y * (tileDimension + 1) + 10,tileDimension,tileDimension);
            }
        }
            ...
            for (int j = 0; j < 9; j++) {
                if (getClicked(i,j) >= 0) {
                    ...
                    placeRectangles(blank,
                            i * (tileDimension + 1) + 95,
                            j * (tileDimension + 1) + 10);
                }
            }
        }
